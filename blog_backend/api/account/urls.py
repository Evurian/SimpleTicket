...
from api.account.views import signUp, signIn, google_signIn, profile, profileUpdate, admin_users_list, admin_user_detail

urlpatterns = [
    path('signUp/', signUp, name = 'signUp'),
    path('signIn/', signIn, name = 'signIn'),
    path('google/', google_signIn, name = 'google_signIn'),
